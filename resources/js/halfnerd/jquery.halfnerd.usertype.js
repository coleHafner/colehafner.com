	...
	$( "#user_type" )
		.live( "click", function( event ){
			...
			switch( process.toLowerCase() )
			{
				...
				default:
					$.colorbox({ href:'/resources/ajax/halfnerd_helper.php?task=user_type&process=' + process + '&user_type_id=' + user_type.user_type_id });
					break;
			}//end switch
		});
});
...
**********************************************************************************************************************************/
	...
	this.add = function( form_name )
	{
		...
		$.ajax({
			type: 'post',
			url: '/resources/ajax/halfnerd_helper.php?task=user_type&process=add&user_type_id=0',
	...
	this.modify = function( form_name )
	{
		...
		$.ajax({
			type: 'post',
			url: '/resources/ajax/halfnerd_helper.php?task=user_type&process=modify&user_type_id=' + this.user_type_id,
			data: $( form_name ).serialize( true ),
			success: function( user_type_id ){		
	...
	this.deleteRecord = function()
	{
		$.ajax({
			type:'post',
			url: '/resources/ajax/halfnerd_helper.php?task=user_type&process=delete&user_type_id=' + this.user_type_id,
			data: "",
			success: function( user_type_id ){
...
**********************************************************************************************************************************/
	...
	this.validateAddModForm = function( process, user_type_id )
	{
		...
		$.ajax({
			type: 'post',
			url: '/resources/ajax/halfnerd_helper.php?task=user_type&process=validate',
			data: $( form_name ).serialize( true ),
...
**********************************************************************************************************************************/
	...
	this.refreshList = function()
	{
		$.ajax({
			type: 'post',
			url: '/resources/ajax/halfnerd_helper.php?task=user_type&process=get-type-list&user_type_id=0',
			data: {},
